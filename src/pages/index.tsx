...
const Home = ({ params }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  ...
  // const resetTables = api.db.reset_tables.useQuery();
      ...
      <main className="flex min-h-screen pb-10 flex-col bg-gradient-to-tr from-[#313131] to-[#000000]">
        ...
        <div className="container items-center gap-10 px-4 py-10 justify-center max-w-6xl m-auto">
            ...
            <div style={{backgroundImage: "url(/noah-buscher-8A7fD6Y5VF8-unsplash.jpg)"}} className="relative rounded-3xl w-full h-96 col-span-5 md:col-span-2 bg-cover bg-no-repeat min-h-full z-0">
                ...
                " />
                <svg xmlns="http://www.w3.org/2000/svg" version="1.1" className="w-full m-auto h-full -z-50 lg:mb-80 lg:-mt-40 lg:mr-80 lg:-ml-40 md:mb-32 md:-mt-32 md:mr-32 md:-ml-32 hidden md:flex" viewBox="0 0 1422 800"><g strokeWidth="20" stroke="hsl(30, 100%, 40%)" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeDasharray="18.5 35" transform="rotate(326, 711, 400)"><path d="M322.5 11.5Q904.5 101.5 711 400Q414.5 598.5 1099.5 788.5 " markerEnd="url(#SvgjsMarker3482)" markerStart="url(#SvgjsMarker3483)"></path></g><defs><marker markerWidth="6.5" markerHeight="6.5" refX="3.25" refY="3.25" viewBox="0 0 6.5 6.5" orient="auto" id="SvgjsMarker3482"><polygon points="0,6.5 2.1666666666666665,3.25 0,0 6.5,3.25" fill="hsl(30, 100%, 40%)"></polygon></marker><marker markerWidth="6.5" markerHeight="6.5" refX="3.25" refY="3.25" viewBox="0 0 6.5 6.5" orient="auto" id="SvgjsMarker3483"><polygon points="0,3.25 6.5,0 4.333333333333333,3.25 6.5,6.5" fill="hsl(30, 100%, 40%)"></polygon></marker></defs></svg>
            </div>
          </div>
